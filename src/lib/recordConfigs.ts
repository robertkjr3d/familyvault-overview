...
export const recordConfigs: Record<string, RecordConfig> = {
  ...
  loans: {
    ...
    fields: [
      ...
      { key: "original_amount", label: "Original loan amount", type: "number", money: true, currencyFrom: "currency" },
      { key: "balance", label: "Current balance", type: "number", money: true, currencyFrom: "currency" },
      ...
      { key: "monthly_payment", label: "Actual monthly payment", type: "number", money: true, currencyFrom: "currency", placeholder: "Leave blank to auto-calculate" },
  ...
  savings_accounts: {
    ...
    fields: [
      ...
      { key: "estimated_monthly_payout", label: "Estimated monthly payout (reference only)", type: "number", money: true, currencyFrom: "currency", showIf: (v) => isCpfAccountType(v.account_type) },
  ...
  other_assets: {
    ...
    fields: [
      ...
      { key: "member_id", label: "Owner", type: "member" },
      { key: "currency", label: "Currency", type: "select", options: CURRENCIES, default: "SGD" },
      { key: "estimated_value", label: "Estimated value", type: "number", money: true, currencyFrom: "currency" },
      { key: "last_updated", label: "Value as of", type: "date" },

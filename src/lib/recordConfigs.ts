...
export const recordConfigs: Record<string, RecordConfig> = {
  properties: {
    ...
    fields: [
      ...
      {
        key: "cost_fire_insurance",
        label: "Fire insurance (monthly)",
        type: "number",
        money: true,
        currencyFrom: "currency",
        section: "🏠 Rental",
      ...
      // 🎯 Strategy & Action
      {
        ...
        type: "text",
        placeholder: "e.g. Capital appreciation at 5% p.a., sell by 2028",
      ...
      },
      {
        ...
        label: "Action",
        type: "text",
        placeholder: "e.g. Ask UOB for repricing rate May 2026",
        section: "🎯 Strategy & Action",
      },
      {
        key: "beneficiary",
      ...
      // 🔒 Sharing
      {
        key: "hidden_from_advisors",
        label: "Hide from advisers",
        type: "boolean",
        placeholder:
          "Keep this property out of any adviser's view, even if you've shared this member and category",
        default: false,
        section: "🔒 Sharing",
      },
    ],
  ...
  loans: {
    ...
    fields: [
      ...
      { key: "loan_end_date", label: "Loan end date", type: "date" },
      {
        ...
        label: "Action",
        type: "text",
        placeholder: "e.g. Ask UOB for repricing rate by May 2026",
      },
      { key: "external_url", label: "Bank portal link", type: "text", placeholder: "https://..." },
      {
        ...
        type: "boolean",
        placeholder:
          "Keep this loan out of any adviser's view, even if you've shared this member and category",
        default: false,
      },
    ],
  },
  ...
  insurance_policies: {
    ...
    fields: [
      ...
      {
        key: "also_covers",
        label: "Also covers (optional)",
        type: "chips",
        placeholder: "e.g. Disability — type and press Enter…",
        default: [],
        section: "📋 Policy Details",
      },
      ...
      { key: "policy_number", label: "Policy number", type: "text", section: "📋 Policy Details" },
      {
        ...
        label: "Coverage",
        type: "text",
        placeholder: "e.g. Hospitalisation & Surgical, Critical Illness",
        section: "📋 Policy Details",
      },
      {
        key: "currency",
      ...
      {
        key: "is_giro",
        label: "GIRO / auto-payment",
        type: "boolean",
        placeholder: "Paid automatically — never mark as overdue",
        default: false,
        section: "💳 Premium",
      },
      ...
      },
      {
        ...
        type: "number",
        money: true,
        placeholder: "Cash value if you cancel today — counts toward Net Worth",
        section: "💰 Payout",
      },
      ...
      // When the surrender_value FIGURE was last confirmed (e.g. from a bonus/
      // dividend statement) — distinct from surrender_value_date above, which is
      // the vesting date. Also settable via the quick "Update" control on the
      // insurance card itself (insurance.tsx), same dual-path pattern investments
      // uses for last_updated.
      {
        key: "surrender_value_last_updated",
        label: "Surrender value as of",
        type: "date",
        showIf: (v) => v.surrender_value != null && v.surrender_value !== "",
        section: "💰 Payout",
      },
      ...
      // 🎯 Action
      {
        ...
        label: "Action",
        type: "text",
        placeholder: "e.g. Renew before Mar 2027",
        section: "🎯 Action",
      },
      {
        key: "external_url",
        label: "Policy website / portal link",
        type: "text",
        placeholder: "https://...",
        section: "🎯 Action",
      },
      ...
      // 🔒 Sharing
      {
        ...
        type: "boolean",
        placeholder:
          "Keep this policy out of any adviser's view, even if you've shared this member and category",
        default: false,
        section: "🔒 Sharing",
      },
    ],
  ...
  investments: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Coverage",
        type: "text",
        placeholder: "e.g. 101% on death or TPD",
        showIf: (v) =>
          v.group_name === "ILP (Investment-Linked Policy)" || v.group_name === "Endowment",
      },
      {
      ...
      },
      {
        ...
        type: "boolean",
        placeholder:
          "Keep this holding out of any adviser's view, even if you've shared this member and category",
        default: false,
      },
    ],
  },
  ...
  savings_accounts: {
    ...
    fields: [
      ...
      { key: "interest_rate", label: "Interest rate %", type: "number" },
      {
        ...
        label: "Maturity date",
        type: "date",
        showIf: (v) => isFdLikeAccountType(v.account_type),
      },
      {
        key: "withdrawal_date",
        label: "Withdrawal eligible date",
        type: "date",
        showIf: (v) => isCpfAccountType(v.account_type),
      },
      {
        key: "estimated_monthly_payout",
        label: "Estimated monthly payout (reference only)",
        type: "number",
        money: true,
        currencyFrom: "currency",
        showIf: (v) => isCpfAccountType(v.account_type),
  ...
  other_assets: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Category",
        type: "select",
        options: ["Vehicle", "Jewellery", "Instrument", "Art", "Collectible", "Other"],
        required: true,
        default: "Other",
      },
      { key: "member_id", label: "Owner", type: "member" },
